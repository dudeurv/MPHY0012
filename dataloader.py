...
train_dataset = EndonasalDataset(root='content/Endonasal_Slices_All/Train', low_res=128, isTrain=True)
test_dataset = EndonasalDataset(root='content/Endonasal_Slices_All/Test', low_res=128)
